...
param(
    [string] $AppVeyorProjectUri = 'https://ci.appveyor.com/api/projects/stefanegli/csprojformatter',
...
if ($remoteUrl -notmatch '(?i)(?:github\.com[:/])stefanegli/CsProjFormatter(?:\.git)?$') {
