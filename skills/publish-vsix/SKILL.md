---
name: publish-vsix
description: Publish a CsProjFormatter VSIX release by reading the latest public AppVeyor build version, verifying that the successful build matches the current Git commit, creating the corresponding numeric release tag, and pushing only that tag to the repository's GitHub remote. Use when asked to publish, release, or tag the latest CsProjFormatter AppVeyor build.
---

# Publish CsProjFormatter VSIX
